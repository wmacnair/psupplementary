...
# code_dir          = 'Z:/Documents/Code'
code_dir          = '/Users/macnairw/Documents/Code/'
psuper_dir        = file.path(code_dir, 'psupertime')
devtools::load_all(psuper_dir)
psupplement_dir   = file.path(code_dir, 'psupplementary')
devtools::load_all(psupplement_dir)
```
